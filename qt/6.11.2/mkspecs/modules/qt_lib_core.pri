...
QT.core.enabled_features = cxx11_future cxx17_filesystem std-atomic64 mimetype sharedmemory shortcut systemsemaphore xmlstream xmlstreamreader xmlstreamwriter textdate datestring process processenvironment temporaryfile library settings filesystemwatcher filesystemiterator itemmodel proxymodel sortfilterproxymodel identityproxymodel transposeproxymodel concatenatetablesproxymodel stringlistmodel translation easingcurve animation gestures jalalicalendar islamiccivilcalendar timezone commandlineparser cborstreamreader cborstreamwriter permissions version_tagging shared cross_compile signaling_nan thread future concurrent openssl-linked opensslv30 test_gui test_squish shared cross_compile intelcet stack_protector stack_clash_protection libstdcpp_assertions shared reduce_exports openssl
QT.core.disabled_features = clock-monotonic glib inotify jemalloc cpp-winrt timezone_tzdb static pkg-config debug_and_release separate_debug_info appstore-compliant simulator_and_device rpath force_asserts framework c++20 c++2a c++2b c++2c reduce_relocations wasm-simd128 wasm-exceptions wasm-jspi zstd dbus opensslv11
